    ...
    dropdownRow.innerHTML = `
      <td colspan="25">
        <div class="next">
          ...
          <div class="align"><label>Alternate No: </label>
            <input type="text" id="alt_contact-${order.order_id}" value="${order.alt_contact}" />
          </div>
...
function exportToCSV() {
  ...
  link.download = 'fruits_orders.csv';
